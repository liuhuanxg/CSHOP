                    ...
                    if (!u) {
                        ...
                        var myFilter = function(value, text, id) {
                            ...
                            if (escape(value).indexOf("%u") != -1) { //汉字
                                ...
                                var s=value;
                                s=myString(s);
                                var pinyin=ConvertPinyin(text)
                                result = ConvertPinyin(text).substring(0, len-20) === s || makePy(text)[0].toLowerCase().substring(0, len-20) === s || text.toLowerCase().indexOf(s) > -1 || (id === undefined ? false : id.indexOf(s) > -1)|| pinyin.indexOf(s) != -1;
                            }
                            if (result == true) {
                                return false;
                            } else {
